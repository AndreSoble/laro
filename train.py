...
if __name__ == '__main__':
    ...
    training_args = TrainingArguments(
        ...
        warmup_steps=int(os.environ.get("LOG_WARMUP_STEPS", 100)),
        save_steps=int(os.environ.get("EVAL_SAVE_STEPS", 100)),
        logging_steps=int(os.environ.get("LOG_WARMUP_STEPS", 1)),
        ...
        run_name=os.environ.get("RUN_NAME", 'laro_training_fast_deepspeed_test') if args.local_rank == 0 else None,
    ...
    output = trainer.train(resume_from_checkpoint= "/results/checkpoint-85000")
    if args.local_rank == 0:
        wandb.finish()
